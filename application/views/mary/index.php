<?php $this->load->view('mary/header') ?>
  <div id="popup" style="display:none">
   <img src="http://www.mary-beach-hotel.com/public/img/mary_hotel_popup.jpg" alt="mary bungalow" style="display: block;margin: auto;position: relative;z-index: 2;">
</div>
<script>
...
document.getElementById('popup').style.display = "block";
   		  $('#popup').animate({"display":"block","top":"0px","padding-top":"5%"},2200);
	}, 1500);
...
$today = date("Ymd");
if ($today < '20160110') include('newyear/newyear.php');
?>-->
